...
const features: readonly FeatureDef[] = [
  { icon: IconShieldCheck, titleKey: "landing.features.1.title", textKey: "landing.features.1.text" },
  { icon: IconSmartphone, titleKey: "landing.features.2.title", textKey: "landing.features.2.text" },
  { icon: IconUsers, titleKey: "landing.features.3.title", textKey: "landing.features.3.text" },
  { icon: IconBuilding, titleKey: "landing.features.4.title", textKey: "landing.features.4.text" },
];
...
const enterpriseBullets: readonly BulletDef[] = [
  { icon: IconLink, labelKey: "landing.pro.bullet1" },
  { icon: IconEye, labelKey: "landing.pro.bullet2" },
  { icon: IconBriefcase, labelKey: "landing.pro.bullet3" },
  { icon: IconRefresh, labelKey: "landing.pro.bullet4" },
];

const faqItems: readonly { qKey: TranslationKey; aKey: TranslationKey }[] = [
      ...
      <div className="relative" style={{ overflow: "clip" }}>
        ...
        >
          ...
          <div
            ...
            style={{ bottom: "18%" }}
          >
            <span className="text-[9px] font-medium uppercase tracking-[0.22em]">{t("hero.scroll")}</span>
          ...
          >
            ...
            <div className="relative mx-auto max-w-5xl px-4 sm:px-6">
              <AnimateOnScroll animation="title">
                ...
                >
                  {t("landing.features.title.line1")}
                  <br />
                  {t("landing.features.title.line2")}
                  <br />
                  <span className="text-primary">{t("landing.features.title.line3")}</span>
                </h2>
              </AnimateOnScroll>
                ...
                {features.map(({ icon: Icon, titleKey, textKey }, i) => (
                  ...
                  >
                    <div className="flex flex-col gap-2.5">
                      ...
                      <p className="text-sm leading-relaxed text-secondary">{t(textKey)}</p>
                    </div>
                  </AnimateOnScroll>
                ))}
              </div>
                  ...
                  <div className="flex flex-col items-start gap-4 lg:max-w-sm">
                    <AnimateOnScroll animation="title">
                      ...
                      >
                        ...
                        <span className="text-primary">{t("landing.start.highlight")}</span>
                      </h2>
                    </AnimateOnScroll>

                    <AnimateOnScroll animation="fade-up" delay="200">
                      <p className="text-sm leading-relaxed text-zinc-600">
                        {t("landing.start.desc")}
                      </p>
                    </AnimateOnScroll>
                    ...
                    <AnimateOnScroll animation="fade-up" delay="360">
                      ...
                      >
                        <Link href="/login">{t("landing.start.cta")}</Link>
                      </Button>
                    </AnimateOnScroll>
                  </div>
                </div>
              ...
              <div className="mb-10 text-center">
                <AnimateOnScroll animation="title">
                  ...
                  >
                    ...
                    <br />
                    <span className="text-primary">{t("landing.download.highlight")}</span>
                  </h2>
                </AnimateOnScroll>
                <AnimateOnScroll animation="fade-up" delay="200">
          ...
          >
            ...
            <div className="relative mx-auto max-w-5xl px-4">
              ...
              <ul className="mt-8 grid gap-3 sm:grid-cols-2">
                {enterpriseBullets.map(({ icon: Icon, labelKey }, i) => (
                  <li key={labelKey}>
              ...
              <AnimateOnScroll animation="fade-up" delay="480" className="mt-10 flex items-center justify-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/55">{t("landing.pro.users")}</p>
                </div>
              </AnimateOnScroll>
            </div>
          </section>
          ...
          >
            <div className="mx-auto max-w-2xl px-4">
              ...
              <div className="mt-8 space-y-2.5">
                {faqItems.map((item, i) => (
                  <AnimateOnScroll key={item.qKey} animation="fade-up" delay={staggerDelays[i]}>
          ...
          >
            ...
            <div className="relative mx-auto max-w-2xl px-4 text-center">
              ...
              <AnimateOnScroll animation="fade-up" delay="360" className="mt-7 flex flex-col items-center justify-center gap-3 sm:flex-row">
                ...
                >
                  <Link href="/register">{t("landing.cta.create")}</Link>
                </Button>
                <Button
                  asChild
                  variant="ghost"
